...
<div class="modal fade" id="submitLeaveModal" tabindex="-1" aria-labelledby="submitLeaveModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-content" style="
            ...
            <!-- MODAL BODY -->
            <form action="index.php?url=leave-store" method="POST">
                ...
                <div style="
                    ...
                    <div style="margin-bottom:16px;">
                        ...
                        <select name="leave_type" id="leave_type" required style="
                                width:100%;
                                height:42px;
                                padding:0 12px;
...
">
        ...
        ">
            ...
            "></i>
                            ...
                            <input type="date" name="end_date" id="end_date" required value="<?= $today ?>"
                                min="<?= $today ?>" style="
                width:100%;
                height:42px;
                padding:0 12px;
