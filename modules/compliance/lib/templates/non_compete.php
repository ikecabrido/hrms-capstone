...
if ($templateRecord && !empty($templateRecord['template_content'])) {
    ...
    $documentBody = lc_replace_placeholders(lc_get_fallback_template('non_compete'), $employee, $employer);
...
<div style="
    ...
    ">
        ...
        ">
            ...
            <tr>
                <td style="padding:9px 0;"><strong>Restriction Period</strong></td>
                <td><?= htmlspecialchars($restrictionPeriod ?? 'One (1) Year'); ?></td>
            </tr>

            <tr>
                <td style="padding:9px 0;"><strong>Effective Date</strong></td>
                <td><?= $today ?></td>
            </tr>
        ...
        ">
            ...
            <p>
                This Non-Compete and Non-Solicitation Agreement is entered into
                between <strong>BESTLINK College of the Philippines</strong> and
                <strong><?= $fullName ?></strong>, presently employed as
            ...
            <p>
                During the course of employment, the Employee may obtain access
                to confidential information, institutional strategies, business
                processes, student and employee records, client relationships,
                and other proprietary information belonging to the Employer.
            </p>

            <p>
                The Employee agrees that for a period of
                <strong><?= htmlspecialchars($restrictionPeriod ?? 'One (1) Year'); ?></strong>
                following separation from employment, the Employee shall not,
                without the Employer's prior written consent, directly or
                indirectly engage in activities that unfairly compete with the
                Employer or solicit em_employees, students, clients, or business
                partners for the benefit of another organization where such acts
                would violate applicable laws or contractual obligations.
            </p>

            <p>
                Nothing in this Agreement shall prevent the Employee from
                pursuing lawful employment. The restrictions contained herein
                shall be interpreted only to the extent permitted by applicable
                Philippine laws and jurisprudence governing reasonable
                post-employment restrictive covenants.
            </p>

            <p>
                The Employee acknowledges having read and understood this
                Agreement and voluntarily accepts its terms and conditions.
            </p>
