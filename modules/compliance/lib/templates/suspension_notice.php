...
<div style="
    ...
    ">
        ...
        ">
            ...
            <tr>
                <td style="padding:9px 0;"><strong>Suspension Period</strong></td>
                <td>As determined by Management in accordance with Company policy and applicable labor laws.</td>
            </tr>
        ...
        ">
            ...
            <p>
                This Notice serves to inform you that Management has decided to
                place you under <strong>preventive suspension</strong> pending
                the completion of an administrative investigation concerning an
                alleged violation of the Company's policies, rules, or Code of
                Conduct.
            </p>

            <p>
                Preventive suspension is imposed solely as a precautionary
                measure whenever the continued presence of an employee in the
                workplace may pose a serious and imminent threat to the life,
                safety, property, or operations of the institution, or may
                compromise the integrity of the ongoing investigation. This
                action shall not be construed as a finding of guilt nor as the
                imposition of disciplinary punishment.
            </p>

            <p>
                During the period of preventive suspension, you are directed to
                refrain from reporting for work and from performing any official
                duties unless otherwise instructed by Management. You are also
                expected to remain available for any administrative conference,
                clarification, or investigation that may be required.
            </p>

            <p>
                Upon completion of the investigation, Management shall determine
                the appropriate course of action in accordance with Company
                policies, the requirements of due process, and applicable
