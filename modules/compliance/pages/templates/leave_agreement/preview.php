...
<div class="document-preview">
    ...
    <div class="document-header">
        <h2 class="document-title">LEAVE AGREEMENT</h2>
        <p class="document-subtitle">EMPLOYEE LEAVE APPROVAL</p>
    </div>
    ...
    <table class="document-information">
        ...
        <tr>
            ...
            <td class="info-value"><?= htmlspecialchars($leaveType) ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="info-value"><?= htmlspecialchars($leaveDuration) ?></td>
        </tr>
