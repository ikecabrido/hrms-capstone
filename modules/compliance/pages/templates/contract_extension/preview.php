...
$today = date('F d, Y');
$documentTitle = 'Contract Extension';
...
if ($templateRecord && !empty($templateRecord['template_content'])) {
    ...
    $documentBody = lc_replace_placeholders(lc_get_fallback_template('contract_extension'), $employee, $employer);
...
<div class="document-preview">
    ...
    <div class="document-header">
        <h2 class="document-title">CONTRACT EXTENSION AGREEMENT</h2>
    ...
    <table class="document-information">
        ...
        <tr>
            <td class="info-label">Extension Start</td>
            <td class="info-value"><?= $startDate ?></td>
        </tr>

        <tr>
            <td class="info-label">Extension End</td>
