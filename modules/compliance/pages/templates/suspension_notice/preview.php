...
$today = date('F d, Y');
$documentTitle = 'Suspension Notice';
...
if ($templateRecord && !empty($templateRecord['template_content'])) {
    ...
    $documentBody = lc_replace_placeholders(lc_get_fallback_template('suspension_notice'), $employee, $employer);
...
<div class="document-preview">
    ...
    <div class="document-header">
        <h2 class="document-title">SUSPENSION NOTICE</h2>
        <p class="document-subtitle">ADMINISTRATIVE SUSPENSION NOTICE</p>
    </div>
    ...
    <table class="document-information">
        ...
        <tr>
            <td class="info-label">Suspension Period</td>
            <td class="info-value">
