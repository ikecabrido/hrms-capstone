...
$position      = htmlspecialchars((string) ($employee['position_name'] ?: ($data['employee_position'] ?: '________________')), ENT_QUOTES);
...
$correctedSalary = htmlspecialchars((string) ($_GET['contract_salary_input'] ?? '0.00'), ENT_QUOTES);
...
<div class="document-preview">
    ...
    <div class="document-header">
        <h2 class="document-title">SALARY RECTIFICATION AGREEMENT</h2>
    ...
    <table class="document-information">
        ...
        <tr>
            <td colspan="2">
                <table class="document-information-row">
                    <tr>
                        <td class="info-label">Original Agreement Date</td>
        ...
        <tr>
            <td colspan="2">
                <table class="document-information-row">
                    <tr>
                        <td class="info-label">Rectification / Effectivity Date</td>
        ...
        <tr>
            <td colspan="2">
                <table class="document-information-row">
                    <tr>
                        <td class="info-label">Corrected Salary</td>
                        <td class="info-value">&#8369;<?= $correctedSalary ?></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td colspan="2">
                <table class="document-information-row">
                    <tr>
                        ...
                        <td class="info-value"><?= $employmentStatus ?: '________________'; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
