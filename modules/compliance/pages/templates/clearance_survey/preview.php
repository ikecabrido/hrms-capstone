...
$lastWorkingDay = !empty($_GET['last_working_day']) && strtotime($_GET['last_working_day']) !== false
    ? date('F d, Y', strtotime($_GET['last_working_day']))
    : (!empty($employee['last_working_day']) ? date('F d, Y', strtotime($employee['last_working_day'])) : '________________');
...
<div class="document-preview">
    ...
    <div class="document-header">
        <h2 class="document-title">CLEARANCE SURVEY</h2>
        <p class="document-subtitle">Exit Clearance Checklist and Sign-Off Form</p>
    </div>
    ...
    <table class="document-information">
        ...
        <tr>
            ...
            <td class="info-value"><?= $dateHired ?: '________________'; ?></td>
        </tr>

        <tr>
            <td class="info-label">Last Working Day</td>
            <td class="info-value"><?= $lastWorkingDay ?></td>
        </tr>
    ...
    <div class="document-table-wrap" tabindex="0" aria-label="Clearance checklist table. Swipe horizontally to view all columns.">
    <table class="document-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Turnover of duties completed</td>
            ...
            <tr>
                ...
                <td>No pending departmental accountabilities</td>
                <td class="text-center">____________</td>
                <td>________________</td>
            </tr>
            ...
            <tr>
                ...
                <td>Exit documents completed</td>
                <td class="text-center">____________</td>
                <td>________________</td>
            </tr>
            ...
            <tr>
                <td>Finance</td>
                <td>No outstanding financial obligations</td>
                <td class="text-center">____________</td>
                <td>________________</td>
            </tr>
            ...
            <tr>
                <td>IT / MIS</td>
                <td>Company equipment and system access cleared</td>
                <td class="text-center">____________</td>
                <td>________________</td>
            </tr>
            ...
            <tr>
                ...
                <td>ID card, keys, uniforms and Company property returned</td>
                <td class="text-center">____________</td>
                <td>________________</td>
            </tr>
            ...
            <tr>
                ...
                <td>No pending legal or compliance obligations</td>
                <td class="text-center">____________</td>
                <td>________________</td>
            </tr>
