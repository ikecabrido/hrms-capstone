...
$studyProgram = !empty($_GET['study_program']) ? $_GET['study_program'] : '________________';
...
<div class="document-preview">
    ...
    <div class="document-header">
        <h2 class="document-title">STUDY LEAVE AGREEMENT</h2>
        <p class="document-subtitle">EMPLOYEE STUDY LEAVE APPROVAL</p>
    </div>
    ...
    <table class="document-information">
        ...
        <tr>
            ...
            <td class="info-value"><?= htmlspecialchars($studyProgram) ?></td>
        </tr>

        <tr>
            <td class="info-label">Study Leave Period</td>
            <td class="info-value">
                <?= htmlspecialchars($leaveStart) ?>
                to
                <?= htmlspecialchars($leaveEnd) ?>
            </td>
        </tr>
