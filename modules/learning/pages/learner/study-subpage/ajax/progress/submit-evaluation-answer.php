...
try {
    ...
    $result = $quizSession->submit($sessionId, $learnerId);
    ...
    // Evaluation is the course's final assessment — a passed attempt
    // completes the enrollment directly (unlike Quiz, which only marks
    // one item among many via Progress::markComplete()).
