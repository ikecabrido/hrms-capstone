    ...
    <div class="module-content">
        <div class="ta-dashboard absence-late-container glass-panel">
            ...
            <div style="background: #fff3e0; border-left: 4px solid #FF9800; padding: 15px; margin-bottom: 20px; border-radius: 4px; display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <p style="margin: 10px 0 0 0;">
                        <a href="?page=shifts" style="background: #FF9800; color: white; padding: 8px 16px; border-radius: 4px; text-decoration: none; font-weight: bold; display: inline-block;">Manage Shifts</a>
                    </p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="attendance-table-wrap">
                <h2>Today's Attendance (<?php echo $allEmployees; ?> employees)</h2>
