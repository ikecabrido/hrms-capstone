...
class Page
{
    ...
    private $sections = [
        ...
        'employee-engagement'  => ['communication', 'survey', 'social'],
        'employee-relations'      => ['recognition', 'grievances']
    ];
    ...
    public function getPage()
    {
        ...
        if (!empty($_COOKIE['lastEngagementPage'])) {
            $savedPage = urldecode($_COOKIE['lastEngagementPage']);
            if (in_array($savedPage, $this->allowed)) {
                return $savedPage;
            }
        }
    ...
    public function renderNav()
    {
        ...
        // Grouped sections
        $sectionOrder = ['employee-engagement', 'employee-relations'];
