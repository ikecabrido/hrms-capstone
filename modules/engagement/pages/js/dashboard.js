...
if (window.__engagementDashboardChartsSetup) {
  console.warn('Dashboard charts already initialized for this page.');
} else {
  window.__engagementDashboardChartsSetup = true;
    ...
    try {
      ...
      dashboardCharts.survey = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            data: values,
            backgroundColor: ['#007bff', '#6610f2', '#20c997', '#fd7e14', '#17a2b8', '#6f42c1', '#e83e8c', '#fd7e14'],
            borderColor: '#fff',
            borderWidth: 2
          }]
        },
        options: {
          ...
          plugins: {
            legend: {
              position: 'bottom',
              labels: { padding: 15, font: { size: 12 }, boxWidth: 15 }
            },
            tooltip: {
              callbacks: {
    ...
    try {
      ...
      dashboardCharts.feedback = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            data: values,
            backgroundColor: ['#17a2b8', '#28a745', '#ffc107', '#dc3545', '#6c757d', '#007bff', '#e83e8c', '#fd7e14'],
            borderColor: '#fff',
            borderWidth: 2
          }]
        },
    ...
    try {
      ...
      dashboardCharts.grievance = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            data: values,
            backgroundColor: ['#ffc107', '#dc3545', '#17a2b8', '#007bff', '#6f42c1', '#fd7e14', '#28a745', '#e83e8c'],
            borderColor: '#fff',
            borderWidth: 2
          }]
        },
