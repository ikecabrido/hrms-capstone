...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("
        ...
        FROM user_account
        INNER JOIN hrms_employee
            ON hrms_employee.employee_id = user_account.employee_id
        INNER JOIN hrms_roles
            ON hrms_roles.role_id = hrms_employee.role
        LEFT JOIN hrms_department
            ON hrms_department.department_id = hrms_employee.department
